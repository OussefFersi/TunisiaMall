 ...
 */
class categorie extends \TMall\EntityBundle\Entity\categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TMall\\EntityBundle\\Entity\\categorie' . "\0" . 'id', '' . "\0" . 'TMall\\EntityBundle\\Entity\\categorie' . "\0" . 'nom', 'products');
        }
