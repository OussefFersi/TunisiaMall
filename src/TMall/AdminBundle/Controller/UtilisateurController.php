...
use Tmall\AdminBundle\Form\UtilisateurType;
...
class UtilisateurController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('TMallEntityBundle:Utilisateur')->findAll();
        $paginator = $this->get('knp_paginator');
        $pagination = $paginator->paginate(
                $entities, $this->get('request')->query->get('page', 1)/* page number */, 2/* limit per page */
        );
        return $this->render('TmallAdminBundle:Main:contacts.html.twig', array(
    ...
    public function createAction(Request $request) {
        ...
        return $this->render('TmallAdminBundle:Utilisateur:new.html.twig', array(
                    'entity' => $entity,
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('TMallEntityBundle:Utilisateur')->find($id);
        ...
        return $this->render('TmallAdminBundle:Utilisateur:show.html.twig', array(
                    'entity' => $entity,
    ...
    public function editAction($id) {
        ...
        return $this->render('TmallAdminBundle:Utilisateur:edit.html.twig', array(
                    'entity' => $entity,
